    ...
    <!-- Projects-->
        <section class="projects-section bg-light" id="services">
            <div class="container">
                ...
                <div class="col-sm-12 d-flex justify-content-center">
                    <p class="text-center">En IMTECHMEX creemos en las ideas es por eso que nosotros te escuchamos y evaluamos todas las propuestas innovadoras y las convertimos en realidad a través de nuestras marcas y sus servicios:</p>
                </div>
